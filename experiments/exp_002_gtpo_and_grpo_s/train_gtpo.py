"""
GTPO training script for exp_002.
Based on exp_001's grpo_llama32_gsm8k.py with GRPOTrainer replaced by GTPOTrainer.
"""

import re, os, sys

# Add src/ to path for GTPOTrainer import
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/workspace/outputs_gtpo",
}

# GTPO-specific hyperparameters (from paper)
GTPO_CONFIG = {
    "alpha1": 1.0,
    "alpha2": 0.1,
    "eps_entropy_low": 0.2,
...
# ─────────────────────────────────────────────────────────────────────────────
# REWARD FUNCTIONS (same as exp_001)
# ─────────────────────────────────────────────────────────────────────────────
