"""
GRPO-S training on MATH-500 (exp_004).
Combines: exp_002 GRPO-S trainer + exp_003 dataset/tags/rewards.
"""
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/workspace/outputs_exp004_grpo_s",
}
...
def main():
    print("=== Exp 004: GRPO-S on MATH-500 ===")
    ...
    trainer = GRPOSTrainer(
        ...
        train_dataset=dataset, reward_funcs=REWARD_FUNCS, **GRPO_S_CONFIG,
    )
