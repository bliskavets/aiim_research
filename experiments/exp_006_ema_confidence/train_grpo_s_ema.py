"""GRPO-S-EMA training on GSM8K (exp_006). Last-EMA sequence-level signal."""
import re, os, sys
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp006_grpos_ema",
}
...
def main():
    print(f"=== Exp 006: GRPO-S-EMA on GSM8K (λ={GRPO_S_EMA_CONFIG['lam']}, k={GRPO_S_EMA_CONFIG['top_k']}) ===")
