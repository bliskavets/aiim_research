"""
GRPO-S-EMA on MATH-500 (exp_007).
= exp_004 setup + exp_006 GRPO-S-EMA method.
"""
import re, os, sys
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp007_grpos_ema",
}
...
def main():
    print(f"=== Exp 007: GRPO-S-EMA on MATH-500 (λ={GRPO_S_EMA_CONFIG['lam']}) ===")
    ...
    print("Starting GRPO-S-EMA training on MATH-500...")
    trainer.train()
