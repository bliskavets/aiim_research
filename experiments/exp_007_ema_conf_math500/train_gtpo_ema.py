"""
GTPO-EMA on MATH-500 (exp_007).
= exp_004 setup (MATH-500, <think>/<answer>, answer bonus=5.0)
+ exp_006 method (EMA-smoothed per-token confidence, λ=0.9)
"""
import re, os, sys
sys.path.insert(0, "/workspace/exp_006")   # reuse exp_006 trainers
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp007_gtpo_ema",
}
...
def main():
    print(f"=== Exp 007: GTPO-EMA on MATH-500 (λ={GTPO_EMA_CONFIG['lam']}) ===")
    ...
    print("Starting GTPO-EMA training on MATH-500...")
    trainer.train()
