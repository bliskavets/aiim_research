"""
GRPO-S-EMA v2 on GSM8K with Qwen3-4B (exp_010)
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp010_grpos_ema_v2",
}
...
def main():
    print(f"=== Exp 010: GRPO-S-EMA v2 Qwen3-4B GSM8K (fixed EMA signal, beta2={GRPOS_CONFIG['beta2']}) ===")
