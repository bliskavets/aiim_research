"""
GTPO-EMA v2 on MATH-500 with Qwen3-4B (exp_011)
= exp_007 setup (MATH-500, <think>/<answer>, bonus=5.0)
+ exp_010 fixed EMA trainer (no z-score normalization)
"""
import re, sys
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp011_gtpo_ema_v2",
}
...
def main():
    print(f"=== Exp 011: GTPO-EMA v2 Qwen3-4B MATH-500 (alpha2={GTPO_CONFIG['alpha2']}) ===")
