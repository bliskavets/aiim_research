"""
GRPO baseline on MATH-500 with Qwen3-4B (exp_012)
= exp_008 model (Qwen3-4B) + exp_003/004/007 setup (MATH-500, <think>/<answer>, bonus=5.0)
Pure GRPO baseline to compare against EMA methods from exp_011.
"""
import re
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp012_grpo_math500",
}
...
def main():
    print("=== Exp 012: GRPO Qwen3-4B MATH-500 (baseline) ===")
    ...
    args = GRPOConfig(max_prompt_length=max_prompt_length,
                      ...
                      **TRAINING_CONFIG)
    trainer = GRPOTrainer(model=model, tokenizer=tokenizer, args=args,
