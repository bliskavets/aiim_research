...
=========================================================================
Experiment 018: GTPO-EMA on integer-filtered Big-Math with large group size.

Method: GTPO-EMA (token-level EMA confidence shaping), adapted from exp_010.
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/mnt/data/outputs/exp_018",
    "bf16": True,
    "fp16": False,
}
...
def main():
    ...
    print("exp_018 — GTPO-EMA on Big-Math (integer filter), 16 gens, bs=4, bf16")
