...
=========================================================================
Experiment 019: GRPO-S entropy on integer-filtered Big-Math with large group size.

Method: GRPO-S (sequence-level entropy shaping), adapted from exp_002.
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/mnt/data/outputs/exp_019",
    "bf16": True,
    "fp16": False,
}
...
def main():
    ...
    print("exp_019 — GRPO-S entropy on Big-Math (integer filter), 16 gens, bs=4, bf16")
