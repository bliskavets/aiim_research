...
=========================================================================
Experiment 020: GTPO per-token entropy on integer-filtered Big-Math with large group size.

Method: GTPO (per-token entropy shaping), adapted from exp_002.
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/mnt/data/outputs/exp_020",
    "bf16": True,
    "fp16": False,
}
...
def main():
    ...
    print("exp_020 — GTPO per-token entropy on Big-Math (integer filter), 16 gens, bs=4, bf16")
