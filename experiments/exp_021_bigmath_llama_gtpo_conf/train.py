...
=========================================================================
Experiment 021: GTPO-Conf (confidence, no EMA) on integer-filtered Big-Math with large group size.

Method: GTPO-Conf (per-token confidence shaping, no EMA), adapted from exp_005.
Same dataset/model/hyperparams as exp_017 (baseline GRPO).
"""
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/mnt/data/outputs/exp_021",
    "bf16": True,
    "fp16": False,
}
...
def main():
    ...
    print("exp_021 — GTPO-Conf (confidence, no EMA) on Big-Math (integer filter), 16 gens, bs=4, bf16")
