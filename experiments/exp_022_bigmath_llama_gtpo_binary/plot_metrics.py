"""Plot training metrics for exp_022 (GTPO per-token entropy)."""
import re
import os
import json
import numpy as np
...
COLOR = "tab:red"
EXP_LABEL = "exp_022 GTPO"
CUSTOM_KEYS = [
    ("gtpo_binary/mean_token_advantage", "Mean Token Advantage"),
    ("gtpo_binary/mean_entropy",         "Mean Entropy"),
    ("gtpo_binary/frac_pos",             "Fraction O+ Sequences"),
]
CUSTOM_TITLE = "exp_022 — GTPO binary Internal Metrics"
...
def main():
    ...
    title = "exp_022 — GTPO binary · Llama-3.2-3B · Big-Math (integer) · 16 gens · bf16"
    plot_dashboard(rec, os.path.join(OUT_DIR, "dashboard.png"), title)
    plot_custom(rec, os.path.join(OUT_DIR, "gtpo_binary_metrics.png"))
