"""
exp_023 — GTPO-EMA with binary O+/O- split from answer_exact reward
================================================================
Same base config as exp_017/020 (Llama-3.2-3B, Big-Math integer,
16 gens, bs=4, 1000 steps, bf16).

Key change vs exp_018: O+/O- is determined by `answer_exact >= 0.0`
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/mnt/data/outputs/exp_023",
    "bf16": True,
    "fp16": False,
}
...
from src.gtpo_ema_binary_trainer import GTPoEMABinaryTrainer
...
def main():
    ...
    print("exp_023 — GTPO-EMA with binary O+/O- (answer_exact >= 0.0)")
