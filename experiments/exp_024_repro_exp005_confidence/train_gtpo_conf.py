"""
GTPO-Conf training on GSM8K (exp_005).
Same setup as exp_002 GTPO, but with confidence-based reward shaping.
"""
import re, os, sys
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp024_gtpo_conf",
}
GTPO_CONF_CONFIG = {"alpha1": 1.0, "alpha2": 0.1, "top_k": 20, "reward_threshold": 0.0}
...
def main():
    print("=== Exp 024 (repro exp_005): GTPO-Conf on GSM8K ===")
    ...
    trainer = GTPOConfTrainer(model=model, tokenizer=tokenizer, args=args, train_dataset=dataset, reward_funcs=REWARD_FUNCS, **GTPO_CONF_CONFIG)
    print("Starting GTPO-Conf training...")
    trainer.train()
