"""
exp_026: Pure-proof GTPO-EMA with flipped O+/O- signal roles on GSM8K.

Identical training config to exp_005 / exp_024 / exp_025. Only the trainer
differs — see src/ema_flipped_utils.py for the rationale.
"""
import re, os, sys
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp026_gtpo_ema_flipped",
}
...
def main():
    print("=== Exp 026: Flipped pure-proof GTPO-EMA on GSM8K ===")
    ...
    print("Starting GTPO-EMA-Flipped training...")
    trainer.train()
