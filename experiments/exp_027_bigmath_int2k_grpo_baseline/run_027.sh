#!/usr/bin/env bash
# run_027.sh — launch exp_027 (GRPO baseline on Big-Math int-2000).
# Same runtime pattern as exp_025 / exp_026.

set -e

REPO_ROOT="/mnt/data/aiim_research"
EXP_NAME="exp_027_bigmath_int2k_grpo_baseline"
