#!/usr/bin/env bash
# run_028.sh — launch exp_028 (flipped GTPO-EMA on Big-Math int-2000).
# Same runtime pattern as exp_027.

set -e

REPO_ROOT="/mnt/data/aiim_research"
EXP_NAME="exp_028_bigmath_int2k_flipped_gtpo_ema"
