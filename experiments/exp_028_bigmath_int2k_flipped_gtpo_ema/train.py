"""
exp_028 — Flipped pure-proof GTPO-EMA on Big-Math integer-2000
==============================================================
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/workspace/outputs_exp028",
    "bf16": True,
    "fp16": False,
}
...
def main():
    ...
    print("=== Exp 028: Flipped GTPO-EMA on Big-Math (integer, 2000 examples) ===")
