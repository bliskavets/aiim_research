"""
exp_032 — Flipped pure-proof GTPO-EMA on Big-Math integer-2000
==============================================================
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/workspace/outputs_exp032",
    "bf16": True,
    "fp16": False,
}
...
FLIPPED_CONFIG = {
    "alpha1": 0.95, "alpha2": 0.05, "lam": 0.9, "top_k": 20,
}
...
def main():
    ...
    print("=== Exp 032: Flipped GTPO-EMA on Big-Math (integer, 2000 examples) ===")
