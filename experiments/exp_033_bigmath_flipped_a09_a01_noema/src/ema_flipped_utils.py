...
def compute_gtpo_ema_flipped_advantages(
    ...
    # exp_033 ablation: no EMA — use raw confidence C directly.
    # `lam` kwarg is kept in the signature for compatibility but ignored here.
    ema     = confidence * completion_mask       # raw C, zeroed past end-of-seq
    ema_inv = 1.0 / (ema + EPS)
