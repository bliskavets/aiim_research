"""
exp_033 — Flipped pure-proof GTPO-EMA on Big-Math integer-2000
==============================================================
...
TRAINING_CONFIG = {
    ...
    "max_grad_norm": 1.0,
    "report_to": "none",
    "output_dir": "/workspace/outputs_exp033",
    "bf16": True,
    "fp16": False,
}
...
FLIPPED_CONFIG = {
    "alpha1": 0.9, "alpha2": 0.1, "lam": 0.9, "top_k": 20,
}
...
def main():
    ...
    print("=== Exp 033 (no-EMA): Flipped GTPO-EMA on Big-Math (integer, 2000 examples) ===")
