"""
exp_035: Pure-proof GTPO-EMA with flipped O+/O- signal roles on GSM8K.
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp035",
}
...
def main():
    print("=== Exp 035: Flipped pure-proof GTPO-EMA on GSM8K ===")
