"""
exp_036: GRPO-S-Conf on GSM8K with Qwen3-4B.
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp036_grpos_conf",
}
...
def main():
    print("=== Exp 036: GRPO-S-Conf on GSM8K (Qwen3-4B) ===")
