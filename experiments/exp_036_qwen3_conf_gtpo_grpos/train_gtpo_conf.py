"""
exp_036: GTPO-Conf on GSM8K with Qwen3-4B.
Identical to exp_024 (repro of exp_005) except model = Qwen/Qwen3-4B, max_seq=4096.
"""
import re, os, sys
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp036_gtpo_conf",
}
...
def main():
    print("=== Exp 036: GTPO-Conf on GSM8K (Qwen3-4B) ===")
