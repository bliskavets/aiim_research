"""
exp_038: GRPO baseline — Qwen3-4B on Big-Math int-2000.
Same dataset as exp_027 (Llama baseline), model swapped to Qwen/Qwen3-4B.
...
TRAINING_CONFIG = {
    ...
    "output_dir": "/workspace/outputs_exp038",
...
def main():
    print("=== Exp 038: GRPO baseline Qwen3-4B on Big-Math int-2000 (bs=4, gens=8, 1000 steps) ===")
    ...
    print(f"Starting GRPO: {TRAINING_CONFIG['num_generations']} gens × bs={TRAINING_CONFIG['per_device_train_batch_size']} = {TRAINING_CONFIG['num_generations']*TRAINING_CONFIG['per_device_train_batch_size']} seqs/step")
    trainer.train()
