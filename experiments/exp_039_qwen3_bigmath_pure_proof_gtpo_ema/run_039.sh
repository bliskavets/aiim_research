#!/usr/bin/env bash
# run_039.sh — Qwen3-4B GTPO-EMA-flipped on Big-Math int-2000 (bs=4, gens=8, 1000 steps).

set -e

REPO_ROOT="/mnt/data/aiim_research"
EXP_NAME="exp_039_qwen3_bigmath_pure_proof_gtpo_ema"
