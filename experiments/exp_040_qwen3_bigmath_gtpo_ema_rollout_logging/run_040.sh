#!/usr/bin/env bash
# run_040.sh — Qwen3-4B GTPO-EMA-flipped + rollout logging on Big-Math int-2000
#              (bs=4, gens=8, 1000 steps). Saves per-rollout top-20 confidences
#              and correctness labels to rollout_logs/.

set -e

REPO_ROOT="/mnt/data/aiim_research"
EXP_NAME="exp_040_qwen3_bigmath_gtpo_ema_rollout_logging"
