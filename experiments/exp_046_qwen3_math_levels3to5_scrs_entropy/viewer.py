"""
viewer.py — exp_046 rollout viewer with per-token confidence visualisation.
    ...
    if _tokenizer is None:
        try:
            ...
            _tokenizer = AutoTokenizer.from_pretrained(
                "Qwen/Qwen3-4B", token=HF_TOKEN or None, trust_remote_code=True)
...
<head>
<meta charset="utf-8">
<title>exp_046 rollout viewer</title>
<style>
