"""
plot_metrics.py — 4-way comparison for exp_050 (tag-masked shaping, full reward).
...
def main():
    ...
    fig.suptitle("exp_050 — Big-Math int-2000, Llama-3.2-3B · tag-masked shaping (full reward) · "
    ...
    out = os.path.join(HERE, "figures", "exp050_4way_comparison.png")
