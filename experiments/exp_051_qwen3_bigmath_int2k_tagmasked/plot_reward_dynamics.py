"""
plot_reward_dynamics.py — reward dynamics for exp_051 (Qwen3-4B):
...
def main():
    ...
    ax.set_title(
        "exp_051 — Qwen3-4B reward dynamics: GRPO baseline vs 3 tag-masked candidates\n"
        "Big-Math int-2000, 500 steps, full reward set, rolling-20 smoothed",
    ...
    out = os.path.join(HERE, "figures", "exp051_reward_dynamics_4way.png")
