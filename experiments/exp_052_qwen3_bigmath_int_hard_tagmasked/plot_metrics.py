"""
plot_metrics.py — 4-way comparison for exp_052 (tag-masked shaping, full reward).
...
def main():
    ...
    fig.suptitle("exp_052 — Big-Math int-hard (Llama-8B<0.3), Qwen3-4B · tag-masked shaping (full reward) · "
