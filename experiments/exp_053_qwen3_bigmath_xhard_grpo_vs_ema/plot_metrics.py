"""
plot_metrics.py — 2-way comparison for exp_053 (tag-masked shaping, full reward).
...
def main():
    ...
    fig.suptitle("exp_053 — Big-Math integer ∩ Llama-8B<=0.125, Qwen3-4B · grpo vs gtpo_ema_flipped tagmasked (full reward, llama8b<=0.125) · "
