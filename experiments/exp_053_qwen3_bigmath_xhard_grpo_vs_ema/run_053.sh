#!/usr/bin/env bash
# run_053.sh — exp_053: Qwen3-4B GRPO vs GTPO-EMA-flipped (tag-masked) on
...
echo "=== [$(date -Is)] Pre-flight: wiping exp_053's own previous artefacts ==="
sudo rm -rf \
...
echo ""
echo "=== [$(date -Is)] Launching exp_053 (2 methods: grpo + gtpo_ema_flipped, sequential) ==="
