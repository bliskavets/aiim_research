"""
plot_metrics.py — 2-way comparison for exp_054 (tag-masked shaping, full reward).
...
def main():
    ...
    fig.suptitle("exp_054 — Big-Math integer ∩ Llama-8B<=0.125, Qwen3-4B · grpo vs gtpo_ema_flipped tagmasked (full reward, llama8b<=0.125) · "
    ...
    out = os.path.join(HERE, "figures", "exp052_4way_comparison.png")
