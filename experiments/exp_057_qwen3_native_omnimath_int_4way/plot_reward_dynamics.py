"""
plot_reward_dynamics.py — reward dynamics for exp_057 (Qwen3-4B):
GRPO baseline (no mask) + GTPO-EMA-flipped (6-tag mask) on
Omni-MATH integer-answer subset.
...
def main():
    ...
    ax.set_title(
        "exp_057 — Qwen3-4B reward dynamics, 4 methods (Qwen3 native format)\n"
        "Omni-MATH integer-answer subset (1971 problems), "
    ...
    out = os.path.join(HERE, "figures", "exp057_reward_dynamics.png")
