"""
plot_metrics.py — 2-way comparison for exp_057 (tag-masked shaping, full reward).
...
def main():
    ...
    fig.suptitle("exp_057 — Omni-MATH integer-answer subset, Qwen3-4B · grpo vs gtpo_ema_flipped tagmasked · "
