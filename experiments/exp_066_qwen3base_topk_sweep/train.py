...
def main():
    ...
    ap.add_argument("--lam", type=float, default=None,
                    help="override EMA lambda (default 0.9)")
    ap.add_argument("--top_k", type=int, default=None,
                    help="override top_k for confidence C = -mean_topk log p (default 20)")
    a = ap.parse_args()
    ...
    if a.top_k is not None and a.method in SHAPING_CONFIG and "top_k" in SHAPING_CONFIG[a.method]:
        SHAPING_CONFIG[a.method]["top_k"] = a.top_k
        tag = f"{tag}_k{a.top_k}"
