...
EXP = "exp073"
METHOD_SUFFIX = "flipped_budget"
METHOD_LABEL = "bonus budget (no posdisc)"
SUBTITLE = "per-rollout sum of alpha2 bonus made length-invariant (= polarity mean active length); replaces position discount"
