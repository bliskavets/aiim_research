...
EXP = "exp074"
METHOD_SUFFIX = "surprisal_credit"
METHOD_LABEL = "surprisal credit"
SUBTITLE = "additive alpha2*g(t)*z_polarity(-log p(o_t)): reward surprising tokens when correct, punish confident tokens when wrong"
