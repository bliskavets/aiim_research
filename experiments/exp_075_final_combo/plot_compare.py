...
EXP = "exp075"
METHOD_SUFFIX = "final_combo"
METHOD_LABEL = "final combo (gate+branch+budget)"
SUBTITLE = "zero-variance gate + branching signal h + length-invariant budget; lam=0.7 k=5"
