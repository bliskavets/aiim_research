...
% ================= USER =================
\node[card, align=center, minimum width=26mm, minimum height=26mm] (user) at (1.15,9.55)
  {\hd{User prompt} $p$\\[12mm]};
% person + speech-bubble icon, BELOW the text; head centred over shoulders
% shoulders: dome centred at x=1.02 (arc centre = start point + radius)
\fill[color=P7B90B2] (0.58,8.68) arc (180:0:0.44) -- cycle;
% head: circle centred at the same x=1.02
\fill[color=E8C39E] (1.02,9.40) circle (0.24);
% speech bubble to the upper right
\fill[color=genA, rounded corners=2.4pt] (1.46,9.36) rectangle (2.18,9.80);
\fill[color=genA] (1.58,9.36) -- (1.78,9.36) -- (1.58,9.16) -- cycle;
...
% ================= RETURN =================
\node[card, fill=ambF, draw=ambA, align=center, minimum width=30mm, minimum height=24mm] (ret) at (18.35,4.35)
  {\hd{return} $h_{\mathrm{best}}$\\[1pt] $=\arg\max_h s(h)$\\[11mm]};
% trophy icon
\fill[color=GOLDF] (18.09,4.02) -- (18.61,4.02) -- (18.50,3.70) -- (18.20,3.70) -- cycle;
\draw[color=GOLDD, line width=0.7pt] (18.09,3.98) arc (140:220:0.20);
\draw[color=GOLDD, line width=0.7pt] (18.61,3.98) arc (40:-40:0.20);
\fill[color=GOLDF] (18.31,3.70) rectangle (18.39,3.56);
\fill[color=GOLDD] (18.22,3.56) rectangle (18.48,3.50);

% ================= ARROWS =================
\draw[flow] (user.east|-genprompt.west) -- (genprompt.west);
