...
% ================= USER =================
\node[card, align=center, minimum width=26mm, minimum height=26mm] (user) at (2.025,2.95)
...
\fill[color=P7B90B2] (1.455,2.08) arc (180:0:0.44) -- cycle;
% head: circle centred at the same x=1.02
\fill[color=E8C39E] (1.895,2.80) circle (0.24);
% speech bubble to the upper right
\fill[color=genA, rounded corners=2.4pt] (2.335,2.76) rectangle (3.055,3.20);
\fill[color=genA] (2.455,2.76) -- (2.655,2.76) -- (2.455,2.56) -- cycle;
...
% ================= ARROWS =================
\draw[flow] (user.north) |- (genprompt.west);
