...
\fill[color=P7B90B2] (0.80,8.68) arc (180:0:0.22) -- cycle;
% head: circle centred at the same x=1.02
\fill[color=E8C39E] (1.02,8.90) circle (0.12);
% speech bubble to the upper right
\fill[color=genA, rounded corners=1.2pt] (1.24,8.86) rectangle (1.60,9.08);
\fill[color=genA] (1.30,8.86) -- (1.40,8.86) -- (1.30,8.76) -- cycle;
