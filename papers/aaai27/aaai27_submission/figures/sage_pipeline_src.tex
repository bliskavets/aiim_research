...
\newcommand{\trophyicon}{\begin{tikzpicture}[scale=1.55,baseline=-0.5ex]
  \fill[GOLDF] (-0.26,0.32) -- (0.26,0.32) -- (0.15,0.0) -- (-0.15,0.0) -- cycle;
  \draw[GOLDD,line width=0.55pt] (-0.26,0.28) arc (140:220:0.20);
  \draw[GOLDD,line width=0.55pt] (0.26,0.28) arc (40:-40:0.20);
  \fill[GOLDF] (-0.04,0.0) rectangle (0.04,-0.13);
  \fill[GOLDD] (-0.13,-0.13) rectangle (0.13,-0.19);
\end{tikzpicture}}
...
% ================= RETURN =================
\node[card, fill=ambF, draw=ambA, align=center] (ret) at (18.35,4.35)
  {\hd{return} $h_{\mathrm{best}}$\\[1pt] $=\arg\max_h s(h)$\\[3mm] \trophyicon};
