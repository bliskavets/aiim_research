...
% ================= USER =================
\node[card, align=center, minimum width=26mm, minimum height=26mm] (user) at (1.15,2.95)
...
\fill[color=P7B90B2] (0.58,2.08) arc (180:0:0.44) -- cycle;
% head: circle centred at the same x=1.02
\fill[color=E8C39E] (1.02,2.80) circle (0.24);
% speech bubble to the upper right
\fill[color=genA, rounded corners=2.4pt] (1.46,2.76) rectangle (2.18,3.20);
\fill[color=genA] (1.58,2.76) -- (1.78,2.76) -- (1.58,2.56) -- cycle;
...
% ================= ARROWS =================
\draw[flow] (user.east) -- ++(0.35,0) |- (genprompt.west);
