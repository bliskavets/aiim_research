...
% ================= JUDGE =================
\node[card, minimum width=33mm, minimum height=17mm] at (12.65,7.83) {};
\node[card, minimum width=33mm, minimum height=17mm] at (12.65,7.99) {};
...
\node[card, text width=26mm] (judresp) at (15.45,10.3)
  {\hd{judge response}\\[2pt]
   ...
   {\ttfamily\footnotesize </criteria$_k$>}};
\node[note] at (15.45,8.98) {$\times K$ aspects};
...
\node[card, fill=ambF, draw=ambA, align=center] (ret) at (18.35,4.3)
  {\hd{return} $h_{\mathrm{best}}$\\[1pt] $=\arg\max_h s(h)$};
