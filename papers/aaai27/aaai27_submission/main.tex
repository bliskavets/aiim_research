...
\end{sc}
\end{small}
\caption{AIME~2026 accuracy in reasoning (thinking) mode. \method{} requires no external reward model. \textcolor{orange!85!black}{Scores are on the 30-problem AIME~2026 set and are not comparable to the full-benchmark results in \cref{tab:results-by-model}.}}
\label{tab:aime2026}
\end{table*}
\begin{table*}[t]
\centering
