...
\begin{figure}[t]
\centering
\includegraphics[width=0.85\columnwidth,height=0.2\textheight]{figures/pearson_correlation_distribution.pdf}
...
\subsection{Evaluation on a broader range of benchmarks: IFEval and MMLU-Pro STEM}
...
<is_incomplete>{is_incomplete}</is_incomplete>
<is_repetitive>{is_repetitive}</is_repetitive>
<is_useful>{is_useful}</is_useful>
\end{verbatim}
\end{small}
\end{minipage}
